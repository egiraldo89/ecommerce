...
function App() {
  ...
  return (
    <>
      ...
      {/* <Table
        headerColumns={['uno', 'dos', 'tres']}
        bodyData={[
          ['cdhbcdhcbd', 'ddedget', 'jnrfrfr'],
          ['cdhbcdhcbd', 'ddedget', 'jnrfrfr'],
          ['cdhbcdhcbd', 'ddedget', 'pepe']
        ]}
        footerData={['foot 1', 'foot 2', 'foot 3']}></Table>
      <Title titleSize={6} data={'este es un titulo de prueba'}></Title> */}
    </>
  )
}
